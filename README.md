...
Win32-Raspbian-Wifi-Injector v1.1 is the first official release for public use.

OS requirement: Vista or higher (Windows doesn't support XP anymore, so neither do I)
